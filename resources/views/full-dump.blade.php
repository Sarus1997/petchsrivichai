        ...
        <div class="row">
            <div class="col-lg-6 col-lg-offset-3 col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1">
                <div class="section-title-s2">
                    <p style="text-align: center; font-size: 30px; color: #026FBA"><b>@lang('messages.services_title_6')</b></p>
                    <hr>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col col-md-12" style="background: #fff;">
                <div class="container-fluid details">
                    <br>
                    <ul><b>@lang('messages.services_title_7')</b></ul>
                ...
                <div class="row" style="text-align: center;">
                    <div class="col-5 col-md-5">
                        <img src="assets/images/portfolio/services-1.jpg" alt="" style="border-radius: 50%; width: 280px; height: 280px; border: 8px solid #82BEE1; object-fit: cover;">
                    </div>
                    <div class="col-2 col-md-2">
                    </div>
                    <div class="col-5 col-md-5">
                        <img src="assets/images/portfolio/services-2.jpg" alt="" style="border-radius: 50%; width: 280px; height: 280px; border: 8px solid #82BEE1; object-fit: cover;">
                    </div>
                </div>
                <br>
                <br>
